...
// navbarIndicator(dom, header, "nav-colo");
...
// function BarProgressBar(entradaBar,direccion) {
...
// const derecha = (entrada) =>{
//   BarProgressBar(entrada,"-")
// }

// const izquierda = (entrada) =>{
//   BarProgressBar(entrada,"")
// }
...
// scrollObserver(derecha, lineBarsr);
// scrollObserver(derecha, circleRight);
// scrollObserver(izquierda, lineBarsl);
// scrollObserver(izquierda, circleLeft);
